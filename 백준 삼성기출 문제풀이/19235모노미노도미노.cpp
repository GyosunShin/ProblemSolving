	...
	while(true){	
		...
		for(int i = 9 ; i >= 6 ; --i){
			...
			if(flag){
				...
				downPush();
				printf("rowCheck후 downPusj한 후의 상태\n");
				pt();
				break;
			}
		}
...
//	printf("Blue 떨어뜨리기 작업 직후\n");
//	pt();
	
	// 열(세로) 가득찬거 있는지 확인하기 
	score += colCheck();
//	printf("Blue colCheck() 직후\n");
//	pt();
	
	// 연한색 처리 
	whiteBlue(); 
//	printf("Blue 연한색 작업 직후\n");
//	pt();
...
//	printf("Green 떨어뜨리기 작업 직후\n");
//	pt();	
	
	// 행(가로) 가득찬거 있는지 확인하기 
	score += rowCheck();
//	printf("Green rowCheck() 작업 직후\n");
//	pt();	
	
	// 연한색 처리
	whiteGreen();
//	printf("Green 연한색 작업 직후\n");
//	pt();	
